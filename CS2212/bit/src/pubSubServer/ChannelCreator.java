...
public class ChannelCreator {
	...
	protected AbstractChannel addChannel(String channelName) {
		...
		//TODO can we do this like channel discovery? ChannelPoolManager.getInstance().addChannel(channelName) instead of cpm?
		// or since this really only runs once at the beginning do we not car if the instance may be out of date?
	}
