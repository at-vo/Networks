 ...
 */
public class EventTypeNew extends AbstractEvent {
	 ...
	 * @param payload
	 */
	protected EventTypeNew(long eventID, int eventPublisherId, EventMessage payload) {
		super(eventID, eventPublisherId, payload);
	}

	public int getEventTypeOf() {
		return 0; // return 0 if new, 1 if sale, 2 if clearance
	}
}