...
public class EventFactory {
	...
	public static AbstractEvent createEvent(EventType eventType, int eventPublisherId, EventMessage payload) {
		...
		switch(eventType){
			case EventTypeSale :
				return new EventTypeSale(EventIDMaker.getNewEventID(), eventPublisherId, payload);
			case EventTypeClearance :
				return new EventTypeClearance(EventIDMaker.getNewEventID(), eventPublisherId, payload);
			default :
				return new EventTypeNew(EventIDMaker.getNewEventID(), eventPublisherId, payload);
		}

		// return null; default case covers what is to be made
	}
