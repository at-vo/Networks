 ...
 */
public class EventTypeClearance extends AbstractEvent {
	 ...
	 * @param payload
	 */
	protected EventTypeClearance(long eventID, int eventPublisherId, EventMessage payload) {
		super(eventID, eventPublisherId, payload);
	}

	public int getEventTypeOf() {
		return 2; // return 0 if new, 1 if sale, 2 if clearance
	}
}