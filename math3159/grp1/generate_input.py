...
def generate_inputs(s) :
    ...
    p = ps[0]
    pa = random_exponents(s)
    pc = random.randint(1,p**pa)
    pb = pc**2 % p**pa

    c = ps[1]
    ca = random_exponents(s)
    cc = random.randint(1,c**ca)
    cb = cc**2  % c**ca

    n = ps[2]
    na = random_exponents(s)
    nc = random.randint(1,n**na)
    nb = nc**2 % n**na

    print((p,pa, pc, pb),(c,ca, cc, cb),(n,na, nc, nb))
...
# this returns (p,a,c,b) by the notation in the assignment
